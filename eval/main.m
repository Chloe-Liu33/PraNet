...
ResultMapPath = 'D:/imgR/imgR2/PraNet-master/res_improved-noenhance/';
Models = {'PraNet'}; %{'UNet','UNet++','PraNet','SFA'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = 'D:/imgR/imgR2/SINet/Dataset/TestDataset/';
Datasets = {'Locust-mini'}; %{'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'};
